...
public class Main {
    public static void main(String[] args) {
        ...
        User user1 = new User("1", "s3", new ArrayList<>(asList("6", "7", "8", "0", "1", "2", "3", "4", "5")), "s4", 0, false);
        User user2 = new User("2", "s4", new ArrayList<>(asList("0", "1", "2", "3", "4", "5", "6", "7", "8")), "s3", 0, false);
        ...
        System.out.println("yey " + requestService.getPairFlag(user2));
    }
}
